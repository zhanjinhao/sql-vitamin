 ...
 */
public class DruidTombstoneRewriterUpdateTest {
  ...
  @Test
  public void test1() {
    for (String sql : SqlReader.read("src/test/resources/cn/addenda/sql/vitamins/test/rewriter/tombstone/TombstoneUpdate.test", sqls)) {
      String source = sql;
      ...
      String s = druidTombstoneRewriter.rewriteUpdateSql(DruidSQLUtils.toLowerCaseSQL(sqlStatements.get(0)));
