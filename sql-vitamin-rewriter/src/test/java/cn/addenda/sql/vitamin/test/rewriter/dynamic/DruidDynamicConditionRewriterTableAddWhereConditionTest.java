package cn.addenda.sql.vitamin.test.rewriter.dynamic;
...
public class DruidDynamicConditionRewriterTableAddWhereConditionTest {
  ...
  @Test
  public void test1() {
    String[] read = SqlReader.read("src/test/resources/cn/addenda/sql/vitamin/test/rewriter/dynamic/DynamicSQLRewriterTableAddWhereCondition.test", sqls);
