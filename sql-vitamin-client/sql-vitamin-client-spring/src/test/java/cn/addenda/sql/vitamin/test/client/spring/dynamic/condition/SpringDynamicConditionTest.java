 ...
 */
public class SpringDynamicConditionTest {
  ...
  public static void before() {
    ...
    context.register(DynamicConditionTestConfiguration.class);
    context.refresh();
    ...
    DynamicConditionUtils.dynamicCondition(
        DynamicConditionConfigBatch.of(
            ArrayUtils.asArrayList(DynamicConditionConfig.of(
                DynamicConditionOperation.TABLE_ADD_JOIN_CONDITION, "users", "if_del = 1", null))),
        new Runnable() {
          @Override
          @SneakyThrows
          public void run() {
