...
import cn.addenda.sql.vitamin.client.spring.aop.dynamic.tablename.DynamicTableNameRewriterConfigurer;
import cn.addenda.sql.vitamin.client.spring.aop.dynamic.tablename.EnableDynamicTableName;
...
public class DynamicTableNameTestConfiguration {
  ...
  public DataSource dataSource() {
    return DruidDataSourceManager.getDataSource("vitamin_dynamictablename");
  }
