...
import cn.addenda.sql.vitamin.rewriter.visitor.identifier.IdentifierOfInsertUpdateItemExistsVisitor;
...
public class IdentifierOfInsertUpdateItemExistsVisitorTest {
  ...
  @Test
  public void test1() {
    for (String sql : SqlReader.read("src/test/resources/cn/addenda/sql/vitamin/test/core/IdentifierOfInsertUpdateItemExistsVisitor.test", sqls)) {
      String source = sql;
