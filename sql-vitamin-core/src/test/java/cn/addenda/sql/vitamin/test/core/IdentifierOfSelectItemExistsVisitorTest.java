...
import cn.addenda.sql.vitamin.rewriter.visitor.identifier.IdentifierOfSelectItemExistsVisitor;
...
public class IdentifierOfSelectItemExistsVisitorTest {
  ...
  @Test
  public void test1() {
    String[] read = SqlReader.read("src/test/resources/cn/addenda/sql/vitamin/test/core/IdentifierOfSelectItemExistsVisitor.test", sqls);
