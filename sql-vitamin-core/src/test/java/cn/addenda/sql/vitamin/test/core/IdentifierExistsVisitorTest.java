...
import cn.addenda.sql.vitamin.rewriter.visitor.identifier.IdentifierExistsVisitor;
...
public class IdentifierExistsVisitorTest {
  ...
  @Test
  public void test1() {
    String[] read = SqlReader.read("src/test/resources/cn/addenda/sql/vitamin/test/core/IdentifierExistsVisitor.test", sqls);
