package cn.addenda.sql.vitamin.rewriter.visitor.tablename;
...
public class TableRenameVisitor extends MySqlASTVisitorAdapter {
  ...
  private TableRenameVisitor(String sourceTableName, String targetTableName) {
    if (sourceTableName == null) {
      throw new SqlVitaminException("`sourceTableName` can not be null!");
    }
    if (targetTableName == null) {
      throw new SqlVitaminException("`targetTableName` can not be null!");
    }
