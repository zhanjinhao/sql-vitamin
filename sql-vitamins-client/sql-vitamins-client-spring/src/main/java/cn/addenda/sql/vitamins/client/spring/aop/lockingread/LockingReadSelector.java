...
import cn.addenda.sql.vitamins.rewriter.lockingread.LockingReadException;
 ...
 */
public class LockingReadSelector extends AbstractSqlVitaminsAopModeImportSelector<EnableLockingRead> {
  ...
  protected String[] selectImports(SqlVitaminsAopMode sqlVitaminsAopMode) {
    if (sqlVitaminsAopMode == SqlVitaminsAopMode.ONLY_CONFIG) {
      return new String[]{
        ...
        LockingReadConfigConfiguration.class.getName()};
    } else if (sqlVitaminsAopMode == SqlVitaminsAopMode.PROXY_CONFIG) {
      return new String[]{
        AutoProxyRegistrar.class.getName(),
        LockingReadConfigConfiguration.class.getName(),
        LockingReadProxyConfiguration.class.getName()};
    }
