package cn.addenda.sql.vitamins.test.client.spring.dynamic.suffix;
...
import cn.addenda.sql.vitamins.client.spring.aop.dynamic.suffix.EnableDynamicSuffix;
...
public class DynamicSuffixTestConfiguration {
  ...
  public DataSource dataSource() {
    return DruidDataSourceManager.getDataSource("vitamins_dynamicsuffix");
  }
